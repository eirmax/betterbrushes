package com.eirmax.betterbrushes.item.Brushes;
...
public class Netherite_brush extends BrushItem {
    public static final int ANIMATION_DURATION = 10;
    private static final int MAX_BRUSH_TIME = 20;

    public Netherite_brush(Item.Settings settings) {
        super(settings);
    }

    public ActionResult useOnBlock(ItemUsageContext context) {
        PlayerEntity playerEntity = context.getPlayer();
        if (playerEntity != null && this.getHitResult(playerEntity).getType() == Type.BLOCK) {
        ...
        public static DustParticlesOffset fromSide(Vec3d userRotation, Direction side) {
            ...
            switch (side) {
                ...
                case EAST:
                    ...
                    break;
                default:
                    throw new MatchException(null, (Throwable)null);
            }
